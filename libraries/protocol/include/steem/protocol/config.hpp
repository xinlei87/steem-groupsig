...
#ifdef IS_TEST_NET
#define STEEM_ANONYMOUS_ACCOUNT               (std::string("nya"))
...
#define STEEM_HARDFORK_REQUIRED_WITNESSES     2 // 17 of the 21 dpos witnesses (20 elected and 1 virtual time) required for hardfork. This guarantees 75% participation on all subsequent rounds.
...
#define STEEM_MAX_TRANSACTION_SIZE            (2048*64)
