...
#define STEEM_INIT_PRIVATE_KEY                (fc::ecc::private_key::regenerate(fc::sha256::hash(std::string("initminera"))))
// #define STEEM_INIT_PRIVATE_KEY                (std::string("5K5HjRpNpc1Mnph8zxq8LkteQhfN9CbCXqCkqNjP2aBmqc5LWNT"))
#define STEEM_INIT_PUBLIC_KEY_STR             (std::string("TST5Hzj64eoJ4isaj5GLnAGf5BGtjXd4hXjaeUZEexcukaUW7NQUN"))
...
#define STEEM_INIT_PUBLIC_KEY_STR             "TST5Hzj64eoJ4isaj5GLnAGf5BGtjXd4hXjaeUZEexcukaUW7NQUN"
...
#define STEEM_INIT_MINER_NAME                 "initminera"
